...
function App() {
  const { authUser } = useAuthContext(); // Retrieve authentication status from context
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow">
        <Suspense fallback={<div>Loading...</div>}> // Show loading indicator while components are being loaded
          <Routes>
            ...
            <Route path="/otp-verification" element={<Verifyotp />} /> // Route for OTP verification page
            <Route path="/post" element={<Post />} /> // Route for post creation page
            ...
            <Route path="*" element={<Navigate to="/" />} /> // Redirect any unknown paths to root
          </Routes>
        </Suspense>
      </div>
    </div>
